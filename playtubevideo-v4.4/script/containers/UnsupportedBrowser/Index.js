                    ...
                    <div className="col-12">
                        <div className="browserSupportWrap">
                            ...
                            <div className="browsers">
                                ...
                                <p>{props.t(props,"Your browser isn’t supported anymore. Update it to get the best {{site_url}} experience and our latest features.",{site_url:props.pageData.appSettings["site_title"]})}
                                </p>
