...
const video = {
    ...
    WITHDRAWREQERROR:"Withdraw request amount must be greater than or equal to thresold amount",
...
const reel = {
    SUCCESS:"Reel create successfully.",
    EDIT:"Reel edited successfully.",
...
const movie = {
    ...
    EPISODENUMBEREXISTS:"Episode Number already exists for this season.",
    ...
    EPISODEEMPTY:"Episode Number is required field",
    SEASONEMPTY:"Season Number is required field",
    VIDEOUPLOADPROCESSING:"Video uploaded successfull, you will get notification once we complete processing your upload video.",
    SEASONIMAGEAdd:"Season image uploaded successfully.",
    SEASONIMAGEEDIT:"Season image edited successfully.",
    EPISODESEASONEXISTS:"Full Movie or Episode already created, please choose different category."
}
...
const channel = {
    ...
    ADDEDQUEUE:"Request added to queue, you will get notification once import finished.",
    EXISTSCHANNEL:"You have already imported videos from this channel.",
    NOTEXISTSCHANNEL:"Channel you're importing does not exists."
...
const error = {
    ...
    RATINGREQ:"Rating should not be empty",
